...
export default function AIAuditForm() {
  ...
  const handleSectionClick = (sectionIndex: number) => {
    // Allow clicking on completed sections or the first section
  ...
  const handleSectionComplete = (sectionIndex: number) => {
    if (!completedSections.includes(sectionIndex + 1)) {
      setCompletedSections([...completedSections, sectionIndex + 1]);
    }
    if (sectionIndex + 1 < 6) {
  ...
  const sections = [
    { id: "contact", title: "Contact Information", index: 0 },
    { id: "operations", title: "Business Operations", index: 1 },
    { id: "automation", title: "Automation & Support", index: 2 },
    { id: "marketing", title: "Marketing & Inventory", index: 3 },
    { id: "challenges", title: "Challenges & Goals", index: 4 },
    { id: "implementation", title: "Implementation", index: 5 },
  ];
  ...
  const SectionHeader = ({ section, isExpanded, isLocked }: any) => (
    <button
  ...
  return (
    <>
      <AlertDialog open={showCancelAlert} onOpenChange={setShowCancelAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Cancel Form?</AlertDialogTitle>
            <AlertDialogDescription>
              You are about to cancel. Are you sure about it?
            </AlertDialogDescription>
          </AlertDialogHeader>
        ...
        <div className="section-center">
          ...
          <Card className="p-6 md:p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {/* Contact Information - Section 0 */}
              <div className="space-y-4">
                <SectionHeader
                  section={sections[0]}
                  isExpanded={expandedSection === 0}
                  isLocked={isSectionLocked(0)}
                />
                {expandedSection === 0 && (
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="sell1" className="font-normal cursor-pointer">
                            Shopify
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="WooCommerce" id="sell2" />
                          <Label htmlFor="sell2" className="font-normal cursor-pointer">
                            WooCommerce
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Amazon/Flipkart" id="sell3" />
                          <Label htmlFor="sell3" className="font-normal cursor-pointer">
                            Amazon/Flipkart
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Instagram/Whatsapp" id="sell4" />
                          <Label htmlFor="sell4" className="font-normal cursor-pointer">
                            Instagram/Whatsapp
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Own Website" id="sell5" />
                          <Label htmlFor="sell5" className="font-normal cursor-pointer">
                            Own Website
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Multiple platforms" id="sell6" />
                          <Label htmlFor="sell6" className="font-normal cursor-pointer">
                            Multiple platforms
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="D2C" id="sell7" />
                          <Label htmlFor="sell7" className="font-normal cursor-pointer">
                            D2C
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Own app" id="sell8" />
                          <Label htmlFor="sell8" className="font-normal cursor-pointer">
                            Own app
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="escalate1" className="font-normal cursor-pointer">
                            Whatsapp
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Instagram DM" id="escalate2" />
                          <Label htmlFor="escalate2" className="font-normal cursor-pointer">
                            Instagram DM
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Email" id="escalate3" />
                          <Label htmlFor="escalate3" className="font-normal cursor-pointer">
                            Email
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Phone" id="escalate4" />
                          <Label htmlFor="escalate4" className="font-normal cursor-pointer">
                            Phone
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Website Chat" id="escalate5" />
                          <Label htmlFor="escalate5" className="font-normal cursor-pointer">
                            Website Chat
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Marketplace" id="escalate6" />
                          <Label htmlFor="escalate6" className="font-normal cursor-pointer">
                            Marketplace
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="support1" className="font-normal cursor-pointer">
                            Yes
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="No" id="support2" />
                          <Label htmlFor="support2" className="font-normal cursor-pointer">
                            No
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Partial" id="support3" />
                          <Label htmlFor="support3" className="font-normal cursor-pointer">
                            Partial
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="query1" className="font-normal cursor-pointer">
                            Order Status
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Product Questions" id="query2" />
                          <Label htmlFor="query2" className="font-normal cursor-pointer">
                            Product Questions
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Returns/Exchange" id="query3" />
                          <Label htmlFor="query3" className="font-normal cursor-pointer">
                            Returns/Exchange
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Payment Issues" id="query4" />
                          <Label htmlFor="query4" className="font-normal cursor-pointer">
                            Payment Issues
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Delivery Delays" id="query5" />
                          <Label htmlFor="query5" className="font-normal cursor-pointer">
                            Delivery Delays
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Other" id="query6" />
                          <Label htmlFor="query6" className="font-normal cursor-pointer">
                            Other
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="order1" className="font-normal cursor-pointer">
                            Yes
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="No" id="order2" />
                          <Label htmlFor="order2" className="font-normal cursor-pointer">
                            No
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Partial" id="order3" />
                          <Label htmlFor="order3" className="font-normal cursor-pointer">
                            Partial
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="marketing1" className="font-normal cursor-pointer">
                            Instagram Ads
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Google Ads" id="marketing2" />
                          <Label htmlFor="marketing2" className="font-normal cursor-pointer">
                            Google Ads
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Facebook Ads" id="marketing3" />
                          <Label htmlFor="marketing3" className="font-normal cursor-pointer">
                            Facebook Ads
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Influencer Marketing" id="marketing4" />
                          <Label htmlFor="marketing4" className="font-normal cursor-pointer">
                            Influencer Marketing
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Organic/SEO" id="marketing5" />
                          <Label htmlFor="marketing5" className="font-normal cursor-pointer">
                            Organic/SEO
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Multiple Channels" id="marketing6" />
                          <Label htmlFor="marketing6" className="font-normal cursor-pointer">
                            Multiple Channels
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="spend1" className="font-normal cursor-pointer">
                            &lt; Rs 50K
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="50k - 2L" id="spend2" />
                          <Label htmlFor="spend2" className="font-normal cursor-pointer">
                            50k - 2L
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="2L - 5L" id="spend3" />
                          <Label htmlFor="spend3" className="font-normal cursor-pointer">
                            2L - 5L
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="5L - 10L" id="spend4" />
                          <Label htmlFor="spend4" className="font-normal cursor-pointer">
                            5L - 10L
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="> 10L" id="spend5" />
                          <Label htmlFor="spend5" className="font-normal cursor-pointer">
                            &gt; 10L
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="inventory1" className="font-normal cursor-pointer">
                            Frequent Stockouts
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Over stocking" id="inventory2" />
                          <Label htmlFor="inventory2" className="font-normal cursor-pointer">
                            Over stocking
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Both options" id="inventory3" />
                          <Label htmlFor="inventory3" className="font-normal cursor-pointer">
                            Both options
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Well managed" id="inventory4" />
                          <Label htmlFor="inventory4" className="font-normal cursor-pointer">
                            Well managed
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="challenge1" className="font-normal cursor-pointer">
                            Customer Support Overload
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Manual Order Processing" id="challenge2" />
                          <Label htmlFor="challenge2" className="font-normal cursor-pointer">
                            Manual Order Processing
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Ad Performance" id="challenge3" />
                          <Label htmlFor="challenge3" className="font-normal cursor-pointer">
                            Ad Performance
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Inventory Issues" id="challenge4" />
                          <Label htmlFor="challenge4" className="font-normal cursor-pointer">
                            Inventory Issues
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Team Bandwidth" id="challenge5" />
                          <Label htmlFor="challenge5" className="font-normal cursor-pointer">
                            Team Bandwidth
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Multiple issues" id="challenge6" />
                          <Label htmlFor="challenge6" className="font-normal cursor-pointer">
                            Multiple issues
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="ai1" className="font-normal cursor-pointer">
                            Yes
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="No" id="ai2" />
                          <Label htmlFor="ai2" className="font-normal cursor-pointer">
                            No
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Tried but failed" id="ai3" />
                          <Label htmlFor="ai3" className="font-normal cursor-pointer">
                            Tried but failed
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    {usedAIToolsBefore === "Yes" && (
                      <div>
                        ...
                        <RadioGroup
                          className="mt-2"
                          onValueChange={(value) =>
                            setValue("previousAutomationMethod", value)
                          }
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="Inhouse dev team" id="prev1" />
                            <Label htmlFor="prev1" className="font-normal cursor-pointer">
                              Inhouse dev team
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="Vibe coding" id="prev2" />
                            <Label htmlFor="prev2" className="font-normal cursor-pointer">
                              Vibe coding
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="Outsourcing" id="prev3" />
                            <Label htmlFor="prev3" className="font-normal cursor-pointer">
                              Outsourcing
                            </Label>
                          </div>
                        </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="success1" className="font-normal cursor-pointer">
                            50% Less Support time
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="2x Sales Growth" id="success2" />
                          <Label htmlFor="success2" className="font-normal cursor-pointer">
                            2x Sales Growth
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Better CX" id="success3" />
                          <Label htmlFor="success3" className="font-normal cursor-pointer">
                            Better CX
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Lower Costs" id="success4" />
                          <Label htmlFor="success4" className="font-normal cursor-pointer">
                            Lower Costs
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Scale Without Hiring" id="success5" />
                          <Label htmlFor="success5" className="font-normal cursor-pointer">
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="when1" className="font-normal cursor-pointer">
                            ASAP
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="1 month" id="when2" />
                          <Label htmlFor="when2" className="font-normal cursor-pointer">
                            1 month
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="2 - 3 months" id="when3" />
                          <Label htmlFor="when3" className="font-normal cursor-pointer">
                            2 - 3 months
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="Just Exploring" id="when4" />
                          <Label htmlFor="when4" className="font-normal cursor-pointer">
                            Just Exploring
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="invest1" className="font-normal cursor-pointer">
                            &lt; 200 USD
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="200 - 500 USD" id="invest2" />
                          <Label htmlFor="invest2" className="font-normal cursor-pointer">
                            200 - 500 USD
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="500 - 1000 USD" id="invest3" />
                          <Label htmlFor="invest3" className="font-normal cursor-pointer">
                            500 - 1000 USD
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="1000 - 2000 USD" id="invest4" />
                          <Label htmlFor="invest4" className="font-normal cursor-pointer">
                            1000 - 2000 USD
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="> 2000 USD" id="invest5" />
                          <Label htmlFor="invest5" className="font-normal cursor-pointer">
                            &gt; 2000 USD
                          </Label>
                        </div>
                      </RadioGroup>
